...
LUA_SHA1 = get_hash(os.path.join(CWD, 'skyblog.lua'))
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/2/26/Skyblog_icon.jpg" height="50px" title=""/>
        <h2>Skyblog <span class="links"><a href="https://skyblog.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/skyblog/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/skyblog">Wiki</a></span></h2>
        <p>Archiving Skyblog.</p>
    '''
)
